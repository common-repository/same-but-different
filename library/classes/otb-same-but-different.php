...
class OTB_Same_But_Different {
	 ...
	 * @return  void
	 */
	public function __construct( $file = '', $version = '1.0.14' ) {
		$this->_version 	= $version;
		$this->_text_domain	= 'same-but-different';
		
		//update_option( 'otb_new_plugin_you-can-quote-me-on-that_viewed', false );
		...
		foreach ($this->themes as $theme) {
			...
			'title' => __( 'Our Plugins', 'same-but-different' ),
			'type' => 'content'
		);
		...
		$this->plugins = array (
  			...
  			'beam-me-up-scotty' => array (
				'slug' => 'beam-me-up-scotty',
				'title' => 'Beam me up Scotty',
  				'tagline' => 'A simple and customizable back to top button',
			    'thumbnail' => 'https://www.outtheboxthemes.com/wp-content/uploads/2016/11/beam-me-up-scotty-imac.png',
    			'coming_soon' => false,
    			'new' => false
		  	)
		);
	...
	public function show_related_posts_in_post_footer() {
		...
		$excluded_categories = get_option( $this->settings->base . 'excluded_categories', $this->get_default_value( 'excluded_categories' ) );
	...
	public function enqueue_admin_styles( $hook = '' ) {
		...
		if ( $hook != 'appearance_page_same-but-different_settings' && $hook != 'widgets.php' ) {
			return;
		}
	 ...
	 */
	public static function instance( $file = '', $version = '1.0.14' ) {
